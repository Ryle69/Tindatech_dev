...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col">
      <section className="relative bg-[#d7d2ae] text-white">
        <div className="container px-4 md:px-8 py-32 md:py-40">
  ...
  <ArrowRight className="ml-2 h-4 w-4" />
                ...
                <Button size="lg" className="bg-[#92c06b] text-white px-5 py-2 rounded-md transition duration-300 hover:bg-[#5a8e2d]">
  View Collection
</Button>
      ...
      <section className="py-16 bg-[#ff841fe7]">
      ...
      {/* Newsletter */}
      <section className="py-16  bg-[#ff841fe7] text-white">
        <div className="container px-4 md:px-8 text-center">

          <h2 className="text-3xl font-bold mb-4">Stay Updated</h2>
          <p className="text-white-300 mb-8 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            ...
            <Button className="bg-[#6CA539] text-white px-5 py-2 rounded-md transition duration-300 hover:bg-[#5a8e2d]">
  Subscribe
</Button>
